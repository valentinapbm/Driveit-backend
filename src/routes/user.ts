...
import { signUp,list, signIn, show, update, destroy, updatePicture, changePass, recovery, reset} from "../controllers/user.controller";
...
router.route("/resetpass").post(reset);
